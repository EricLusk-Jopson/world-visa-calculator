  ...
  return (
    <Dialog fullScreen open={open} onClose={onClose}>
          ...
          >
            <TextField
              ...
              onChange={(e) => {
                ...
                if (!ongoing && iso && (!exitDate || exitDate <= iso))
                  setExitDate(formatDate(addDays(parseDate(iso), 1)));
                setError(null);
              }}
              sx={INPUT_SX}
            />
          ...
          <OngoingToggle
            ...
            label={
              region === VisaRegion.Schengen
                ? "Currently inside Schengen (no exit yet)"
                : region === VisaRegion.UnitedKingdom
                  ? "Currently in the UK (no exit yet)"
                  : region === VisaRegion.Ireland
                    ? "Currently in Ireland (no exit yet)"
      ...
      >
        ...
        <Button onClick={handleSave} sx={{ flex: 2 }}>
          Save Trip
        </Button>
      </Box>
    </Dialog>
